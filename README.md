...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xdp7rri.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xdp7rri.containers.anotherwebservice.com/
...
```
git clone git@github.com:h1ack/container-xdp7rri.git
cd container-xdp7rri
```
...
```
docker attach container-xdp7rri
```
